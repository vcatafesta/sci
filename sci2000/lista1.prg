/*
 ...
 Ý³   Ult.Atual....: 26 de Outubro de 2004.                                 ³
...
LOCAL aRotinaAlteracao := {{||InclusaoProduto(OK) }}
LOCAL Arq_Ant			  := Alias()
...
IF !(DbSeek( cCodi ) )
	...
	Pagar->(DbGoTop())
	Pagar->(Escolhe( 03, 01, 22, "Codi + 'º' + Nome + 'º' + Sigla", "CODI NOME DO FORNECEDOR                       SIGLA", aRotina ))
EndIF
SetColor( Cor )
...
oRecemov   := CriaBrowse( 01, 01, 07, MaxCol()-1, "TOTAL FATURA: " + Tran( nTotRece+nTotBido, "@E 999,999.99") + '|' + " PERC PAGO : " + Tran( nPagoPerc, "999%" + '|' + " PERC PAGAR : " + Tran( nPagarPerc, "999%")))
DbGotop()
