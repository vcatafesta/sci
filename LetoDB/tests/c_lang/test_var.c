...
void main( int argc, char *argv[] )
{
   ...
   if( ( pConnection = LetoConnectionNew( szAddr, iPort, NULL, NULL, 0 ) ) != NULL )
   {
      ...
      iRes = LetoVarSet( pConnection, "main", "var_int", LETO_VAR_NUM, "100", 0, NULL );
      if( iRes )
         printf( "Ok\r\n" );
      else
         printf( "Err( %d )\r\n", LetoGetError() );
      ...
      iRes = LetoVarSet( pConnection, "main", "var_int", LETO_VAR_NUM, "100", LETO_VCREAT, NULL );
      if( iRes )
         printf( "Ok\r\n" );
      else
         printf( "Err( %d )\r\n", LetoGetError() );
      ...
      iRes = LetoVarSet( pConnection, "main", "var_log", LETO_VAR_LOG, "1", LETO_VCREAT, NULL );
      if( iRes )
         printf( "Ok\r\n" );
      else
         printf( "Err( %d )\r\n", LetoGetError() );
      ...
      iRes = LetoVarSet( pConnection, "main", "var_char", LETO_VAR_CHAR, "Just a test;", LETO_VCREAT, NULL );
      if( iRes )
         printf( "Ok\r\n" );
      else
         printf( "Err( %d )\r\n", LetoGetError() );

      ptr = LetoVarGet( pConnection, "main", "var_int" );
      printf( "\r\nvar_int = (100) %s\r\n", ( ptr )? ptr+2 : "Err" );
      if( ptr )
         free( ptr );

      ptr = LetoVarGet( pConnection, "main", "var_char" );
      printf( "var_char = (Just a test;) %s\r\n", ( ptr )? ptr+2 : "Err" );
      if( ptr )
         free( ptr );

      ptr = LetoVarGet( pConnection, "main", "var_log" );
      printf( "var_log = (1) %s\r\n", ( ptr )? ptr+2 : "Err" );
      if( ptr )
         free( ptr );
