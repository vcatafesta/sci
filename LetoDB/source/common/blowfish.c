...
static void Blowfish_Init( BLOWFISH_CTX *ctx, const char *key, int keyLen )
{
   int i, j, k;
...
void leto_decrypt( const char *ptri, unsigned long int ulLen, char *ptro, unsigned long int *pLen, const char *key )
{
   ...
   {
      memmove( ptro, ptro+2, ulLen-iDiff );
      *pLen = ulLen-iDiff;
   }
