...
PUBL cCaixa
*:----------------------------------------------------------------------------
MS_SetConsoleTitle("Macrosoft SCI for Windows")
...
function SetaFonteDefault()
***************************	
	//SetMode(maxrow(), maxcol())
	//SetMode(ms_maxrow(), ms_maxcol())
	//SetMode(ms_maxbufferrow(), ms_maxbuffercol())
	//ms_setbuffer()
	//SetMode(ms_maxbufferrow(), ms_maxbuffercol())	
	Ms_SetConsole(oAmbiente:AlturaFonteDefaultWindows, oAmbiente:LarguraFonteDefaultWindows)
	return(SetMode(oAmbiente:AlturaFonteDefaultWindows, oAmbiente:LarguraFonteDefaultWindows))
...
FChdir( oAmbiente:xBaseDados )
Set Defa To ( oAmbiente:xBaseDados )
ms_setconsoletitle(left(SISTEM_NA1, 26))
return
