...
IF Vendedor->(!DbSeek( cCodi ))
   ...
   Vendedor->(Escolhe( 00, 00, 24, "Codiven + 'Ý' + Nome", "ID   NOME FUNCIONARIO ", aRotinaInc, NIL, aRotinaAlt ))
...
Return( aDisp := ReadIni(reless,info rb433.centro: SyberNET-D: data from unknown devi