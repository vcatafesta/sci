...
unsigned int far _CDECL _clear87(void);
unsigned int far _CDECL _control87(unsigned int,unsigned int);
void far _CDECL _fpreset(void);
unsigned int far _CDECL _status87(void);
