...
IF Pagar->(!DbSeek( cCodi ))
	...
	Pagar->(Escolhe( 03, 01, 22,"Codi + 'Ý' + Nome + 'Ý' + Sigla + 'Ý' + Fone", "CODI NOME FORNECEDOR                          SIGLA      TELEFONE", aRotina,, aRotinaAlteracao ))
EndIF
