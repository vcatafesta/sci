...
*----------------*
	...
	Aadd( aArquivos, { "receber",   "receber1","receber2","receber3", "receber4", "receber5","receber6","receber7","receber8","receber9","receber10","receber11"})
...
oIndice:AddNtx("cpf",                 "RECEBER11", "RECEBER" )
oIndice:CriaNtx()
Return
