...
function letoConnect( $addr, $port ) {
  ...
  $msg = "intro;0.99;WEB;WebClient;Alex;;EN;dd/mm/yy;T;;\r\n";
...
function letoVarSet($conn, $group, $var, $type, $value, $lReturn, $lCreate) {
  $fl1 = $lCreate? '!' : ' ';
  $fl2 = $lReturn? '!' : ' ';
  $msg = "var;set;".$group.";".$var.";".strval($value).";".$type.$fl1.$fl2.";\r\n";
  $awr = letoDataSend( $conn, $msg, strlen($msg) );
  if( substr( $awr,0,1 ) == "+" ) {
    $pos = strpos( $awr, ';' );
    if( $pos === false )
