...
Function Main
	...
	cTable := "//10.0.0.66:2812/receber.dbf"
	...
	use (cTable) alias ex
	cCodi := "Codi"
	index On ((&cCodi)) Tag Receber1 To receber
	index On Nome Tag Receber2 To receber
	index On Ende Tag Receber3 To receber
	index On Cida Tag Receber4 To receber
