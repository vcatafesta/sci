...
IF Receber->(!DbSeek( Var ))
	...
	Receber->(DbGoTop())
	Receber->(Escolhe( 03, 00, MaxRow()-2,"Codi + 'Ý' + Nome + 'Ý' + Fone + 'Ý' + Left( Fanta, 15 )", "CODI NOME DO CLIENTE                          TELEFONE       FANTASIA", aRotina,, aRotinaAlteracao ))
...
IF Vendedor->(!DbSeek( Var ))
	...
	Vendedor->(Escolhe( 03, 01, MaxRow()-2, "CodiVen + 'Ý' + Nome", "CODI NOME DO VENDEDOR", aRotina ))
...
IF Receber->(!DbSeek( cCodi ))
	Receber->(Order( RECEBER_NOME ))
	Receber->(DbGoTop())
	Receber->(Escolhe( 03, 01, 22, "Codi + 'Ý' + Nome + 'Ý' + Fone","CODI NOME DO CLIENTE                          TELEFONE", aRotina ))
EndIF
