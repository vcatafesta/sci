/*
 ╒══════════════════════════════════════════════════════════════════════════╕
 │ Source file: SIXTOOLS.PRG                                                │█
 │ Description: Some handy UDF's for use with the SIx Driver                │█
 │ Notice     : Copyright 1993-95 - SuccessWare 90, Inc.                    │█
 │                                                                          │█
 │ Compile    : CLIPPER sixtools /n/w                                       │█
 │                                                                          │█
 ├──────────────────────────────────────────────────────────────────────────┤█
 │                                                                          │█
 │ Odometer()     - For use with the INDEX ON command's OPTION clause.      │█
 │                                                                          │█
 │ Sx_AddKeys()   - Adds an arrayful of keys for the current record to a    │█
 │                  Multi-Keyed, Free-Format Index.                         │█
 │                                                                          │█
 │ Sx_GetKeys()   - Returns an array containing all of the keys in a        │█
 │                  Multi-Keyed, Free-Format Index for the current record.  │█
 │                                                                          │█
 │ Dots()         - Also for use with the INDEX ON command's OPTION clause. │█
 │                                                                          │█
 │ IndexBar()     - Another progress meter like Odometer() for indexing     │█
 │                                                                          │█
 │ ShowIt()       - Yet another                                             │█
 │                                                                          │█
 │ MyAlert()      - Modified Alert() function using black on yellow         │█
 │                                                                          │█
 ╘══════════════════════════════════════════════════════════════════════════╛█
   ███████████████████████████████████████████████████████████████████████████
*/
