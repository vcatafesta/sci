...
int far _CDECL isalpha(int);
int far _CDECL isupper(int);
int far _CDECL islower(int);
int far _CDECL isdigit(int);
int far _CDECL isxdigit(int);
int far _CDECL isspace(int);
int far _CDECL ispunct(int);
int far _CDECL isalnum(int);
int far _CDECL isprint(int);
int far _CDECL isgraph(int);
int far _CDECL iscntr(int);
